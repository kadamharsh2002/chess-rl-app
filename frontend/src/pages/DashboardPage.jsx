        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { step: '1', title: 'Piece Rewards',
              desc: `Pawn +1, Knight/Bishop +3, Rook +5, Queen +9. 
                     Every capture gives instant reward signal.` },
            { step: '2', title: 'Game Outcome',
              desc: `Win = +100 points. Loss = -100 points. 
                     Draw = +10 points. Biggest learning signal!` },
            { step: '3', title: 'Neural Network Updates',
              desc: `After every game, PyTorch trains for 20 epochs 
                     on all moves. Model saved as new version.` },
          ].map((item) => (
            <div key={item.step}
